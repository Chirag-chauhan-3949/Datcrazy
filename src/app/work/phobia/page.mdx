...
export const caseStudy = {
  ...
  summary: [
    'Access precise quantities of parts precisely when you need them, courtesy of our CNC laser cutting service.',
    'We worked with Phobia to develop a new cutting-edge CNC laser cutting system. This system utilizes advanced laser technology to deliver precise and high-quality cuts for various materials.',
  ],
  logo,
  image: { src: imageHero },
  date: '',
