...
export const article = {
  date: '2023-04-06',
  title: 'The Future of 3D-Printing: Our Predictions for 2023',
  description:
    'Let’s explore the latest trends in 3D-Printing, and regurgitate some predictions we read on X for how they will shape the industry in the coming year.',
  author: {
    name: 'Chelsea Hagon',
